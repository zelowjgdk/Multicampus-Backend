...
public class mongodbex11 {
	...
	public static void main(String[] args) {
		try {
			...
			Bson proj = new Document("_id", 0).append("name", 1).append("age", 1).append("office", 1);
...
//		);
			...
			FindIterable<Document> result = collection.find().projection(proj).sort(sort).skip(5).limit(10);
