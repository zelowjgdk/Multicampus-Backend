	...
	<div class="container">
		...
		<form action="travel_add" method="post" class="form mt-5">
			<div class="form-group">
				<label>권역</label> <select name="region" class="form-control" style="width: 200px">
			...
			<div class="form-group">
				<label>관광지명</label> <input type="text" name="title" class="form-control ">
			</div>
			<div class="form-group">
				<label>주소</label> <input type="text" name="address" class="form-control ">
			</div>
			<div class="form-group">
				<label>전화번호</label> <input type="text" name="phone" class="form-control ">
			</div>
			<div class="form-group">
				<label>내용</label>
